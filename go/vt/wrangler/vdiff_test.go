...
func TestVDiffPlanSuccess(t *testing.T) {
	...
	testcases := []struct {
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: false}},
			comparePKs:       []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{0},
			selectPks:        []int{0},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}}),
			targetPrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}}),
		},
	}, {
		input: &binlogdatapb.Rule{
			Match:  "t1",
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: false}, {colIndex: 1, weightStringIndex: 0, isPK: true}},
			comparePKs:       []compareColInfo{{colIndex: 1, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{1},
			selectPks:        []int{1},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 1, weightStringIndex: 0, isPK: true}}),
			targetPrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 1, weightStringIndex: 0, isPK: true}}),
		},
	}, {
		input: &binlogdatapb.Rule{
			Match:  "t1",
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 2, isPK: false}},
			comparePKs:       []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{0},
			selectPks:        []int{0},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}}),
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 2, isPK: false}, {colIndex: 1, weightStringIndex: 0, isPK: true}},
			comparePKs:       []compareColInfo{{colIndex: 1, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{1},
			selectPks:        []int{1},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 1, weightStringIndex: 0, isPK: true}}),
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 2, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: false}},
			comparePKs:       []compareColInfo{{colIndex: 0, weightStringIndex: 2, isPK: true}},
			pkCols:           []int{0},
			selectPks:        []int{0},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 2, isPK: true}}),
			targetPrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 2, isPK: true}}),
		},
	}, {
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: false}, {colIndex: 1, weightStringIndex: 2, isPK: true}},
			comparePKs:       []compareColInfo{{colIndex: 1, weightStringIndex: 2, isPK: true}},
			pkCols:           []int{1},
			selectPks:        []int{1},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 1, weightStringIndex: 2, isPK: true}}),
			targetPrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 1, weightStringIndex: 2, isPK: true}}),
		},
	}, {
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: true}},
			comparePKs:       []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{0, 1},
			selectPks:        []int{0, 1},
			sourcePrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: true}}),
			targetPrimitive:  newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: true}}),
		},
	}, {
		// in_keyrange
		input: &binlogdatapb.Rule{
		...
		td: &tableDiffer{
			...
			compareCols:      []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: false}, {colIndex: 2, weightStringIndex: 0, isPK: false}, {colIndex: 3, weightStringIndex: 0, isPK: false}},
			comparePKs:       []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}},
			pkCols:           []int{0},
			selectPks:        []int{0},
			sourcePrimitive: &engine.OrderedAggregate{
				...
				Input:       newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}}),
			},
			targetPrimitive: newMergeSorter(nil, []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}}),
		},
	}}
...
func TestVDiffFindPKs(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			tdIn: &tableDiffer{
				compareCols: []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: false}, {colIndex: 1, weightStringIndex: 0, isPK: false}},
			...
			tdIn: &tableDiffer{
				compareCols: []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: false}, {colIndex: 1, weightStringIndex: 0, isPK: false}, {colIndex: 2, weightStringIndex: 0, isPK: false}, {colIndex: 3, weightStringIndex: 0, isPK: false}},
				comparePKs:  []compareColInfo{},
				pkCols:      []int{},
			},
			tdOut: &tableDiffer{
				compareCols: []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 1, weightStringIndex: 0, isPK: false}, {colIndex: 2, weightStringIndex: 0, isPK: false}, {colIndex: 3, weightStringIndex: 0, isPK: true}},
				comparePKs:  []compareColInfo{{colIndex: 0, weightStringIndex: 0, isPK: true}, {colIndex: 3, weightStringIndex: 0, isPK: true}},
				pkCols:      []int{0, 3},
				selectPks:   []int{0, 3},
			},
		},
